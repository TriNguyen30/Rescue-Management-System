...
import { ClipboardList, Shield, LogOut, ChevronLeft, ChevronRight, Waves, Menu, X } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
    { key: "requests", label: "Yêu cầu cứu hộ", icon: <ClipboardList className="w-4 h-4" />, path: "/coordinator" },
];
...
export default function CoordinatorSidebar() {
    ...
    const displayName = user?.fullName || user?.username || "Điều phối viên";
