...
import { User, CreateUserPayload, UpdateUserPayload, ChangePasswordPayload, ApiResponse } from "@/types/user";
...
export const getUserByUsername = async (username: string): Promise<User | null> => {
    ...
    const res = await axiosInstance.get<ApiResponse<User> | User>(`/users/${username}`);
